...
namespace GameOfLife
{
    ...
    public class Render : IRender
    {
        ...
        public void RenderTwoFields(GameFieldModel firstGameField, GameFieldModel secondGameField, bool dead = false)
        {
            Console.WriteLine();
            if (!dead)
            {
                for (int yCoordinate = 0; yCoordinate < firstGameField.Width; yCoordinate++)
                {
                    Console.Write(" ");
                    for (int xCoordinate = 0; xCoordinate < firstGameField.Length; xCoordinate++)
                    {
                        Console.Write(" " + firstGameField.GameField[xCoordinate, yCoordinate]);
                    }

                    Console.Write("     ");
                    for (int xCoordinate = 0; xCoordinate < secondGameField.Length; xCoordinate++)
                    {
                        Console.Write(" " + secondGameField.GameField[xCoordinate, yCoordinate]);
                    }
            ...
            public void MultipleGamesModeTwoTitlesRender(int firstGameNumber, int firstCellsAliveNumber, int secondeGameNumber, int secondCellsALiveNumber)
            {
                Console.WriteLine($"\nGame #{firstGameNumber}. Alive: {firstCellsAliveNumber}                Game #{secondeGameNumber}. Alive: {secondCellsALiveNumber}");
            }
